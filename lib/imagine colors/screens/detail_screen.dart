                ...
                Container(
                  child: SliverAppBar(
                    ...
                    actions: [
                      ...
                      IconButton(
                          icon:
                              Icon(Icons.message, color: whiteColor, size: 16),
                          onPressed: () {}),
                    ],
                  ),
                )
        ...
        children: [
                  ...
                  children: [
                    ClipRRect(
                      borderRadius: BorderRadius.only(
                          topLeft: Radius.circular(10),
                          topRight: Radius.circular(10)),
                      child: commonCacheImageWidget(servicesList[index].img, 80,
          ...
          Container(
            ...
            child: RaisedButton(
              ...
              onPressed: () {
                finish(context);
                ICPackageOfferScreen().launch(context);
              },
